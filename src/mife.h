...
typedef struct {
    ...
    void        (*mife_ct_free)(mife_ct_t *ct, const circ_params_t *cp);
    int         (*mife_ct_fwrite)(const mife_ct_t *ct, const circ_params_t *cp, FILE *fp);
    mife_ct_t * (*mife_ct_fread)(const mmap_vtable *mmap, const circ_params_t *cp, FILE *fp);
