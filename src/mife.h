...
typedef struct {
    ...
    void        (*mife_ct_free)(mife_ct_t *ct, const acirc_t *circ);
    int         (*mife_ct_fwrite)(const mife_ct_t *ct, const obf_params_t *op, FILE *fp);
    mife_ct_t * (*mife_ct_fread)(const mmap_vtable *mmap, const obf_params_t *op, FILE *fp);
